    ...
    >
      ...
      <div className="relative">
        <div
          ...
          aria-hidden="true"
        >
          <div className="absolute -top-1 left-1/2 h-2 w-2 -translate-x-1/2 rounded-full bg-gold/40" />
        </div>
        <div
          className="absolute -inset-10 rounded-full border border-white/[0.04]"
          style={{
            animation: "hero-orbit-ring 30s linear infinite reverse",
          }}
          aria-hidden="true"
        >
          <div className="absolute -right-1 top-1/2 h-1.5 w-1.5 -translate-y-1/2 rounded-full bg-teal/30" />
        </div>
